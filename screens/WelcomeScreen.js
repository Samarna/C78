...
export default class WelcomeScreen extends Component {
    ...
    userSignup=(emailId,password,confirmPassword)=>{
        ...
        .then(()=>{
            db.collection('users').add({first_name:this.state.firstName, last_name:this.state.lastName,
                contact:this.state.contact, email_id:this.state.emailId, address:this.state.address});
